...
const PATH_MAP = {
  "tests/unit/conversation-state-test.mjs":
    "tests/unit/extensions/state/conversation-state.test.mjs",
  "tests/unit/patient-profile-test.mjs":
    "tests/unit/extensions/safety/patient-profile.test.mjs",
  "tests/unit/clarification-loop-test.mjs":
    "tests/unit/extensions/state/clarification-loop.test.mjs",
  "tests/unit/grounding-rule-test.mjs":
    "tests/unit/extensions/safety/grounding-rule.test.mjs",
  "tests/unit/llm-judge-test.mjs":
    "tests/unit/extensions/eval/llm-judge.test.mjs",
  "tests/unit/kg-graph-test.mjs": "tests/unit/lib/kg-graph.test.mjs",
  "tests/unit/retrieval-router-test.mjs":
    "tests/unit/lib/retrieval-router.test.mjs",
  "tests/unit/retrieval-fts-test.mjs": "tests/unit/lib/retrieval-fts.test.mjs",
  "tests/unit/faithfulness-guard-test.mjs":
    "tests/unit/extensions/safety/faithfulness-guard.test.mjs",
  "tests/unit/conflict-detector-test.mjs":
    "tests/unit/lib/conflict-detector.test.mjs",
  "tests/unit/rag-search-version-hint-test.mjs":
    "tests/unit/lib/rag-search-version-hint.test.mjs",
  "tests/unit/scope-guard-test.mjs":
    "tests/unit/extensions/safety/scope-guard.test.mjs",
  "tests/unit/query-sanitize-test.mjs":
    "tests/unit/lib/query-sanitize.test.mjs",
  ...
  "tests/unit/engine-version-test.mjs":
    "tests/unit/lib/engine-version.test.mjs",
  "tests/unit/observability-test.mjs": "tests/unit/lib/observability.test.mjs",
  "tests/unit/diagnostic-log-test.mjs":
    "tests/unit/lib/diagnostic-log.test.mjs",
  "tests/unit/provider-health-test.mjs":
    "tests/unit/scripts/service/provider-health.test.mjs",
  "tests/unit/alert-log-test.mjs": "tests/unit/lib/alert-log.test.mjs",
  "tests/unit/multisource/quality-gate-test.mjs":
    "tests/unit/scripts/kb/multisource/quality-gate.test.mjs",
  "tests/unit/multisource/normalize-test.mjs":
    "tests/unit/scripts/kb/multisource/normalize.test.mjs",
  "tests/unit/merge-into-gold-test.mjs":
    "tests/unit/scripts/eval/pipeline/merge-into-gold.test.mjs",
  "tests/unit/guard-replacement-test.mjs":
    "tests/unit/extensions/safety/guard-replacement.test.mjs",
  "tests/unit/patient-forget-test.mjs":
    "tests/unit/extensions/safety/patient-forget.test.mjs",
  "tests/unit/chunk-quality-test.mjs":
    "tests/unit/scripts/eval/quality/chunk-quality.test.mjs",
  "tests/unit/chinese-heading-test.mjs":
    "tests/unit/lib/chinese-heading.test.mjs",
  "tests/unit/ab-prompt-eval-test.mjs":
    "tests/unit/scripts/eval/ab/prompt-eval.test.mjs",
  "tests/unit/generate-ab-input-test.mjs":
    "tests/unit/scripts/eval/ab/generate-input.test.mjs",
  "tests/unit/content-need-alignment-test.mjs":
    "tests/unit/scripts/eval/quality/content-need-alignment.test.mjs",
  "tests/unit/api-server-test.mjs":
    "tests/unit/scripts/service/api-server.test.mjs",
  "tests/unit/session-pool-test.mjs":
    "tests/unit/scripts/service/session-pool.test.mjs",
  "tests/unit/knowledge-engine-search-test.mjs":
    "tests/unit/lib/knowledge-engine-search.test.mjs",
