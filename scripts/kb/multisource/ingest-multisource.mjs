...
//       落盘 raw/ + raw-txt/ → 登记 kb-sources.json →
...
const GAP_TARGETS = [
  ...
  // ── 第二批：呼吸/神经/消化/感染/内分泌缺口（扩展现有 PMC OA 源覆盖范围）──
  {
    id: "cvd-stroke",
    disease: "脑卒中",
    query: "acute ischemic stroke management guideline",
    keywords: ["脑卒中", "缺血性卒中", "脑血管意外", "溶栓", "rt-PA", "取栓", "神经介入"],
  ...
  },
  {
    id: "resp-copd",
    disease: "慢性阻塞性肺疾病",
    query: "COPD chronic obstructive pulmonary disease management guideline",
    keywords: ["慢阻肺", "慢性阻塞性肺疾病", "肺功能", "支气管扩张剂", "吸入激素", "氧疗", "肺康复"],
  ...
  },
  {
    id: "neuro-epilepsy",
    disease: "癫痫",
    query: "epilepsy seizure management clinical guideline",
    keywords: ["癫痫", "惊厥", "抗癫痫药物", "AED", "脑电图", "癫痫持续状态"],
  ...
  },
  {
    id: "infect-tb",
    disease: "结核病",
    query: "tuberculosis diagnosis treatment management guideline",
    keywords: ["结核病", "肺结核", "抗结核", "异烟肼", "利福平", "耐药结核", "DOTS"],
  ...
  },
  {
    id: "gi-cirrhosis",
    disease: "肝硬化",
    query: "liver cirrhosis complications management guideline",
    keywords: ["肝硬化", "门脉高压", "腹水", "食管静脉曲张", "肝性脑病", "肝功能"],
  ...
  // ── 第三批：内分泌/风湿/肾内/血液/消化余量 —— 持续深化 PMC OA 覆盖 ──
  {
    id: "endo-dka",
    disease: "糖尿病酮症酸中毒",
    query: "diabetic ketoacidosis DKA management clinical guideline",
    keywords: ["糖尿病酮症酸中毒", "DKA", "高血糖危象", "胰岛素", "补液", "电解质紊乱"],
  ...
  },
  {
    ...
    disease: "甲状腺功能亢进症",
    query: "hyperthyroidism Graves disease management guideline",
    keywords: ["甲亢", "甲状腺功能亢进", "Graves病", "抗甲状腺药物", "甲巯咪唑", "丙硫氧嘧啶", "放射性碘"],
  ...
  },
  {
    id: "rheum-rheumatoid",
    disease: "类风湿关节炎",
    query: "rheumatoid arthritis management clinical guideline",
    keywords: ["类风湿关节炎", "RA", "抗风湿药", "DMARD", "甲氨蝶呤", "生物制剂", "JAK抑制剂"],
  ...
  },
  {
    id: "gi-pancreatitis",
    disease: "胰腺炎",
    query: "acute pancreatitis management clinical guideline",
    keywords: ["胰腺炎", "急性胰腺炎", "重症胰腺炎", "胰酶", "ERCP", "液体复苏", "坏死"],
  ...
  },
  {
    id: "nephro-ckd",
    disease: "慢性肾脏病",
    query: "chronic kidney disease CKD management clinical guideline",
    keywords: ["慢性肾脏病", "CKD", "肾衰竭", "透析", "肾性贫血", "钙磷代谢", "eGFR"],
  ...
  },
  {
    id: "hemo-anemia",
    disease: "贫血",
    query: "iron deficiency anemia management clinical guideline",
    keywords: ["贫血", "缺铁性贫血", "巨幼细胞性贫血", "铁剂", "维生素B12", "叶酸", "促红素"],
