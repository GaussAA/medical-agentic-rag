...
async function main() {
  ...
  const DISEASE_OVERRIDE = {
    ...
    "临床诊疗指南·癫痫病分册": "癫痫",
    // 2026-08-04 偏科指南入库配套：肝硬化 2025 版 disease 归一为「肝硬化」、
    // 骨质疏松风险管理公众指南归一为「骨质疏松」，使 Q50/Q21/Q34 的 gold 病种
    // 与路由 top3 口径对齐（原 extractDisease 抽出「肝硬化临床诊治管理」过长串，
    // 与 gtSource 解析的「肝硬化」错配，引用召回假阴性）。
    "肝硬化临床诊治管理指南(2025版)": "肝硬化",
    "中国人群骨质疏松症风险管理公众指南(2024)": "骨质疏松",
  };
